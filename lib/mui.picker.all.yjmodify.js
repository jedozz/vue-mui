...
(function ($, window, document, undefined) {
	...
	Picker.prototype.setSelectedValue = function (value, duration, callback) {
		var self = this;
		//for (var index in self.items) { yjmodify
...
(function ($, document) {
	...
	var PopPicker = $.PopPicker = $.Class.extend({
		...
		getSelectedItems: function () {
			var self = this;
			var items = [];
			//for (var i in self.pickers) { yjmodify
...
(function ($, document) {
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_inArray: function (array, item) {
			//for(var index in array) {  yjmodify
